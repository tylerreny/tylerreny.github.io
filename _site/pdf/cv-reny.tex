...
\years{2021-} \emph{Assistant Professor}\\
Department of Politics and Government, Claremont Graduate University\\
\years{} \emph{Faculty Affiliate}
Computational Justice Lab, CGU\\
\years{} \emph{Faculty Affiliate}
Inequality and Policy Research Center, CGU\\
\years{2020} \emph{Postdoctoral Research Fellow}\\Weidenbaum Center, Washington University in St. Louis (2020-2021)
...
\years{} \textbf{Reny, Tyler} and Justin Gest. ``Viewers Like You: How Elite Co-Identity Reinforcement Primes Facilitate Persuasion'' \textit{Under Review}
%\years{} Ben Newman, \textbf{Reny, Tyler} and Jennifer Merolla. ``Race, Prejudice, and Support for Racial Justice Countermovements: The Case of “Blue Lives Matter'' \textit{Under Review}

\subsection*{In preparation}

\years{} Eunji Kim and \textbf{Tyler Reny}. ``Media and Public Perceptions of the Police''\\
\years{} \textbf{Tyler Reny}, Andrew Reeves, and Dino Christenson. ``How Rising Sea Levels Shape Climate Policy Attitudes''\\
\years{} Gest, Justin, Tyler Reny, and Jeremy Ferwerda. ``How Demographic Decline Reduces Immigration Prejudice: A Study in 17 European Countries''\\
...
\years{}American Political Science Association Annual Conference (2016, 2017, 2018,2021)\\
...
\years{2021} Computational Tools for Social Science\\
